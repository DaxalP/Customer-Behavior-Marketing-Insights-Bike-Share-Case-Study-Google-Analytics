...
## Introduction
In this case study, I will perform many real-world tasks of a junior data analyst at a fictional company, Cyclistic. In order to answer the key business questions, I will follow the steps of the data analysis process: [Ask](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#ask), [Prepare](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#prepare), [Process](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#process), [Analyze](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#analyze-and-share), [Share](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#analyze-and-share), and [Act](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/README.md#act).
### Quick links:
Data Source: [divvy_tripdata](https://divvy-tripdata.s3.amazonaws.com/index.html) [accessed on 04/03/23]  
  
SQL Queries:  
[01. Data Combining](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_combining.sql)  
[02. Data Exploration](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_cleaning.sql)  
[03. Data Cleaning](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_exploration.sql)  
[04. Data Analysis](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_analysis.sql)  
  
Data Visualizations: [Tableau](https://public.tableau.com/views/case-study_17568886143280/BikeTypes?:language=en-GB&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)  
## Background
### Cyclistic
...
### Combining the Data
SQL Query: [Data Combining](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_combining.sql)  
12 csv files are uploaded as tables in the dataset '2022_tripdata'. Another table named "combined_data" is created, containing 5,667,717 rows of data for the entire year. 
### Data Exploration
SQL Query: [Data Exploration](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_exploration.sql)  
...
### Data Cleaning
SQL Query: [Data Cleaning](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_cleaning.sql)  
...
## Analyze and Share
SQL Query: [Data Analysis](https://github.com/DaxalP/Customer-Behavior-Marketing-Insights-Bike-Share-Case-Study-Google-Analytics/blob/main/data_analysis.sql)  
Data Visualization: [Tableau](https://public.tableau.com/views/case-study_17568886143280/BikeTypes?:language=en-GB&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)  
